...
try:
    ...
    st.text(
        " stats showing teams defensive capabilities ranked from best based on the total steals and blocks "
    )
    ...
    st.dataframe(df2)
    st.text(
        "shows teams with a above average win probability based on point and their win percentage"
    )
